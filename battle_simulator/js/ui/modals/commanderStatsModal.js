...
export function openCommanderStatsModal() {
  ...
  const sliders = [
    ...
    { sliderId: 'universal-strength-slider', valueId: 'universal-strength-value', value: commanderStats.universal, min: 0, max: 20 },
    { sliderId: 'courtyard-strength-slider', valueId: 'courtyard-strength-value', value: commanderStats.courtyard, min: 0, max: 1500 },
    { sliderId: 'wall-reduction-slider', valueId: 'wall-reduction-value', value: commanderStats.wallReduction, min: 0, max: 280 },
    { sliderId: 'moat-reduction-slider', valueId: 'moat-reduction-value', value: commanderStats.moatReduction, min: 0, max: 180 },
    { sliderId: 'gate-reduction-slider', valueId: 'gate-reduction-value', value: commanderStats.gateReduction, min: 0, max: 280 },
    ...
    { sliderId: 'front-strength-slider', valueId: 'front-strength-value', value: commanderStats.frontStrength, min: 0, max: 20 },
    { sliderId: 'flanks-strength-slider', valueId: 'flanks-strength-value', value: commanderStats.flanksStrength, min: 0, max: 20 }
  ];
