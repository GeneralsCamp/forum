...
export function openCommanderStatsModal() {
  ...
  const sliders = [
    ...
    { sliderId: 'beef-unit-strength-slider', valueId: 'beef-unit-strength-value', value: commanderStats.beefStrength, min: 0, max: 55 },
    { sliderId: 'mead-unit-strength-slider', valueId: 'mead-unit-strength-value', value: commanderStats.meadStrength, min: 0, max: 55 },
