...
export function openBasicsModal() {
  ...
  const sliders = [
    ...
    { sliderId: 'mead-range-level-slider', valueId: 'mead-range-level-value', value: attackBasics.meadRangeLevel, min: 0, max: 11 },
    { sliderId: 'mead-melee-level-slider', valueId: 'mead-melee-level-value', value: attackBasics.meadMeleeLevel, min: 0, max: 11 },
