...
export function openCastellanStatsModal() {
  ...
  const sliders = [
    { sliderId: 'defense-melee-lv-slider', valueId: 'defense-melee-lv-value', value: castellanStats.defenseMeleeLevel, min: 0, max: 11 },
    { sliderId: 'defense-ranged-lv-slider', valueId: 'defense-ranged-lv-value', value: castellanStats.defenseRangedLevel, min: 0, max: 11 },
  ...
  const confirmValues = [
    { sliderId: 'defense-melee-lv-slider', property: 'defenseMeleeLevel', targetObject: castellanStats },
    { sliderId: 'defense-ranged-lv-slider', property: 'defenseRangedLevel', targetObject: castellanStats },
