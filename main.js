const categories = {
    overviews: [
        ...
        { name: "Generals Overview", desc: "This page loads the in-game generals automatically!", icon: "generals-icon.webp", link: "#", disabled: true },
        { name: "Troops Overview", desc: "This page loads the in-game troops automatically!", icon: "troops-icon.webp", link: "#", disabled: true },
        { name: "Tools Overview", desc: "This page loads the in-game tools automatically!", icon: "tools-icon.webp", link: "#", disabled: true },
        { name: "Gacha Overview", desc: "This page loads the in-game gacha rewards automatically!", icon: "gacha-icon.webp", link: "#", disabled: true }
    ],
