...
function generateRelicOptions() {
    const options = [
        { value: 0, label: "None" },
        { value: 50, label: "Relic 1 (+50/h)" },
        { value: 150, label: "Relic 2 (+150/h)" },
        { value: 250, label: "Relic 3 (+250/h)" },
        { value: 350, label: "Relic 4 (+350/h)" },
        { value: 450, label: "Relic 5 (+450/h)" },
        { value: 550, label: "Relic 6 (+550/h)" },
        { value: 650, label: "Relic 7 (+650/h)" },
        { value: 750, label: "Relic 8 (+750/h)" },
        { value: 850, label: "Relic 9 (+850/h)" },
        { value: 1000, label: "Relic 10 (+1000/h)" },
        { value: 1100, label: "Premium 1 (+1100/h)" },
        { value: 1200, label: "Premium 2 (+1200/h)" },
        { value: 1300, label: "Premium 3 (+1300/h)" },
        { value: 1400, label: "Premium 4 (+1400/h)" },
        { value: 1500, label: "Premium 5 (+1500/h)" },
        { value: 1600, label: "Premium 6 (+1600/h)" },
        { value: 1700, label: "Premium 7 (+1700/h)" },
        { value: 1800, label: "Premium 8 (+1800/h)" },
        { value: 1900, label: "Premium 9 (+1900/h)" },
        { value: 2000, label: "Premium 10 (+2000/h)" },
        { value: 2100, label: "Premium 11 (+2100/h)" },
        { value: 2200, label: "Premium 12 (+2200/h)" },
        { value: 2300, label: "Premium 13 (+2300/h)" },
        { value: 2400, label: "Premium 14 (+2400/h)" },
        { value: 2500, label: "Premium 15 (+2500/h)" },
        { value: 2600, label: "Premium 16 (+2600/h)" },
        { value: 2700, label: "Premium 17 (+2700/h)" },
        { value: 2800, label: "Premium 18 (+2800/h)" },
        { value: 2900, label: "Premium 19 (+2900/h)" },
        { value: 3000, label: "Premium 20 (+3000/h)" },
        { value: 3100, label: "Premium 21 (+3100/h)" },
        { value: 3200, label: "Premium 22 (+3200/h)" },
        { value: 3300, label: "Premium 23 (+3300/h)" },
        { value: 3400, label: "Premium 24 (+3400/h)" },
        { value: 3500, label: "Premium 25 (+3500/h)" },
        { value: 3600, label: "Premium 26 (+3600/h)" },
        { value: 3700, label: "Premium 27 (+3700/h)" },
        { value: 3800, label: "Premium 28 (+3800/h)" },
        { value: 3900, label: "Premium 29 (+3900/h)" },
        { value: 4000, label: "Premium 30 (+4000/h)" }
    ];
